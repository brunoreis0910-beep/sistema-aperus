...
INSERT INTO `auth_user` VALUES (3,'pbkdf2_sha256$600000$XIfINmX5GDqos0JQj5gnJU$JAz5XzyCZ6K9bQhhnmw1h/M4Yir8/l8tdsqjCAVbSHA=',NULL,1,'ADMIN','','','',1,1,'2026-05-29 19:23:35.549324');
...
INSERT INTO `configuracoes_impressao` VALUES (2,'venda_rapida','termica','80mm',0,1,1,'','2026-06-03 20:24:46.897049');
...
INSERT INTO `licenca` VALUES (1,'APERUS_LOCAL_LICENSE_KEY','2026-06-10','2026-06-11 11:03:27','Bloqueada');
...
--
-- Table structure for table `saas_template_contrato`
--

DROP TABLE IF EXISTS `saas_template_contrato`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `saas_template_contrato` (
  `id_template` int NOT NULL AUTO_INCREMENT,
  `titulo` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `texto_template` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `ativo` tinyint(1) NOT NULL,
  `criado_em` datetime(6) NOT NULL,
  `atualizado_em` datetime(6) NOT NULL,
  PRIMARY KEY (`id_template`)
...
--
-- Dumping data for table `saas_template_contrato`
--

LOCK TABLES `saas_template_contrato` WRITE;
/*!40000 ALTER TABLE `saas_template_contrato` DISABLE KEYS */;
/*!40000 ALTER TABLE `saas_template_contrato` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-22  9:48:54
