...
# Forçamos o django a carregar o sqlite alterando as vars ou no settings
...
with connection.cursor() as cursor:
    ...
    print("Tabelas do hotel no SQLite:")
    for t in tables:
        print(" -", t[0])

print("\n=== CONTAGEM DE REGISTROS (SQLITE) ===")
try:
